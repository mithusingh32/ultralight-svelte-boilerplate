...
MACRO(ADD_APP source_list)
  ...
  add_custom_command(TARGET ${APP_NAME} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_CURRENT_SOURCE_DIR}/app/public/" "${ASSETS_PATH}")
  ...
  if (APPLE)
    ...
    add_custom_command(TARGET ${APP_NAME} POST_BUILD
      COMMAND ${CMAKE_COMMAND} -E copy "${CMAKE_CURRENT_SOURCE_DIR}/cmake/${MACOSX_BUNDLE_ICON_FILE}.icns" "${RESOURCES_PATH}/../${MACOSX_BUNDLE_ICON_FILE}.icns")
  endif ()
